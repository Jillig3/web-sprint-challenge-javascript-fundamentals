...
// The nested function is able to reach up into the parent (myFunction) and receive the value that was created at const internal.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(data){
    const smallName = data.map(function(item){
